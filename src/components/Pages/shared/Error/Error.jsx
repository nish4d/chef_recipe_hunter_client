...
import errPic from '../../../../assets/errpic.png'
    ...
    <div>
      <div className="bg-gray-100 h-screen justify-center">
        <center className="pt-24 m-auto">
          ...
          <div>
          <img className="w-[40rem] object-cover rounded-lg" src={errPic} alt="" />
          </div>
        ...
        <center className="mt-6">
          <Link
            to="/"
            className="text-white font-mono text-xl bg-primary py-3 px-6 rounded-md hover:bg-[#876a50]"
          >
            Go back
          </Link>
        </center>
