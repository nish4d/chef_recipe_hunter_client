...
const Login = () => {
  ...
  const { userLogin, handleGoogleSingIn, handleGithubSingIn } = useContext(AuthContext);
...
console.log(location)
  ...
  return (
    <div className="flex py-32 justify-center items-center bg-slate-900 bg-opacity-70 bg-blend-overlay" style={{backgroundImage: `url(${bg})`}}>
      {/* login page */}
      <div>
        <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-700 text-gray-100">
          ...
          >
            <div className="space-y-4">
              ...
              {
                err && <h2 className="text-red-500 text-center">Provide valid info !!!!!</h2> 
              }
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <button
                  ...
                  className="p-3 rounded-sm"
                  onClick={handlesGithub}
                >
                  <FaGithub className="text-2xl"></FaGithub>
                </button>
              </div>
              <p className="px-6 flex gap-2 text-sm text-center text-gray-400">
